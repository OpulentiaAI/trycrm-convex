...
export const NAV_ITEMS = [
  ...
  { id: "events", to: "/app/events", label: "Events" },
  { id: "universe", to: "/app/universe", label: "Universe" },
  { id: "research", to: "/app/research", label: "Research" },
  { id: "dossier", to: "/app/dossier", label: "Dossier" },
